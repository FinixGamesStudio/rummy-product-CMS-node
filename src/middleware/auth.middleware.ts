...
import { SUCCESS_MESSAGES, ERROR_MESSAGES, STATUS_CODE, USER_CONSTANT } from '../constant';
...
async function authMiddleware(
  ...
  try {
    ...
    // console.log('authMiddleware :: secret :>> ', secret);
    ...
    // console.log('authMiddleware :: verificationResponse :>> ', verificationResponse);
